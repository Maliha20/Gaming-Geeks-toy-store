  ...
  return (
    <footer className="mt-auto footer p-10 bg-color text-base-content">
      <div>
        ...
        <p className="font-bold text-xl text-yellow-950">
          Gaming Geeks <br />
      ...
      <div>
        <span className="footer-title font-bold text-xl text-yellow-950">
          Games we offer
        </span>
      ...
      <div>
        ...
        <a className="link link-hover text-xl text-yellow-950">
          Selchow and Righter
        </a>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="form-control w-80">
          ...
          <div className="relative">
            ...
            />
            <button className="btn btn-ghost text-amber-50 bg-yellow-950 absolute top-0 right-0 rounded-l-none">
              Subscribe
            </button>
          </div>
          <div className="flex justify-center gap-6 my-6">
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current text-yellow-950"
              >
         ...
         <div>
         <p className="text-center text-yellow-950">Copyright © 2023 - All right reserved</p>
         </div>
        </div>
      </div>
    </footer>
